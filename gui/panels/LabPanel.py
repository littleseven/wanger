...
class LabPanel(MainPanel):
    rel_path = constants.ROOT_PATH
    contentWidth = 0
    contentHeight = 0

    def __init__(self, parent=None, id=-1, displaySize=(1600, 900), Fun_SwFrame=None):
        wx.Panel.__init__(self, parent, size=displaySize, name = '左边容器')
        self.checkEnv()
        ...
        # self.mainPanel.SetSize((self.contentWidth, self.contentHeight))
        ...
        leftPanel.SetSizerAndFit(self.vbox_sizer_left)
        # 加载配置文件
        ...
        rightPanel.SetSizerAndFit(self.vbox_sizer_right)
        ...
        # self.switch_content_panel(self.BackMplPanel, self.LabPanel, True)  # 等类型替换
    ...
    def _ev_select_graph(self, event):
        ...
        if item != 0 and self.pick_graph_last == 0:  # 单图切到多子图
            ...
            # print(self.vbox_sizer_right.GetItem(self.LabPanel))
